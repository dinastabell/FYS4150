...
def plot_MC_cycles(Temp):
    ...
    for i, T in enumerate(Temp):
        ...
        ax[0].plot(steps, Energy_O, color='C0', label='Ordered start configuration')
        ax[0].plot(steps, Energy_R, color='C1', label='Random start configuration')
        ax[0].set_ylabel("Mean energy", fontsize=20)
        ax[0].legend(loc='best')

        ax[1].plot(steps, MagnetizationAbs_O, color='C0', label='Ordered start configuration')
        ax[1].plot(steps, MagnetizationAbs_R, color='C1', label='Random start configuration')
        ax[1].set_ylabel("Mean magnetization ", fontsize=20)
